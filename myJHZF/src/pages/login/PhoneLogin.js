...
//
//export class ScanQRCode extends Component<Props> {
//
//    /** 页面顶部导航配置*/
...
//                        <Image source={require('../../res/img/agrotechnique/back.png')} style={{width:15,height:20}}></Image>
//                    </TouchableOpacity>
//                </View>
//            ),
//            headerTitle: (
...
//                        <ImageBackground source={require('../../res/img/qrcode_bg.png')} style={{width:200,height:200}}>
//                            <Animated.View style={[
//                                styles.border,

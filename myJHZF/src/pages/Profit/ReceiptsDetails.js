...
import {PaydeReclist} from "../http/urlApi"

   export default class ReceiptsDetails extends React.Component {
     constructor(props) {
       super(props);
       this.state = {
         arr:[],
      ...
      return(
        <View key={index} style={{paddingTop:10,paddingBottom:10,marginLeft:10,marginRight:10,flexDirection:'row',justifyContent:'space-between',alignItems:'center',borderBottomWidth:1,borderColor:'#F5F5F5'}}>
            ...
            <View style={{flexDirection:'row',alignItems:'center',}}>
              <Text style={{padding: 6,fontSize: 14,color:'red'}}>收&yen;{item.order_amount}</Text>
